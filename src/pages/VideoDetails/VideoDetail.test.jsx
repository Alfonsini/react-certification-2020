...
describe('Video details', () => {
  test('Video details page render correctly', () => {
    render(<VideoDetailsPage />);
    const row = screen.getByTestId('video-details-page');
    expect(row).toBeInTheDocument();
  });

  test('Video details page render correctly when a video was selected from Home page', async () => {
    render(
      <>
        <Route exact path="/">
          <Sidebar />
  ...
  test('Video details page render correctly from Home page. Testing hover over video clip.', async () => {
    render(
      <>
        <Route exact path="/">
          <Sidebar />
...
//   test('Video details page not render correctly when a video was selected from right side panel of related videos becuase API returns an HTTP error', async () => {
//     render(
//       <>
//         <Route exact path="/">
//           <Sidebar />
